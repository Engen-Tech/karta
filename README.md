...
- **Pi package** — Pi 0.84.2 or a later tested version, Node.js 22.19 or newer, Git, and `uv`. Karta 3.0.0 supports native macOS and Linux; see the [Pi guide](docs/how-to/pi.md#current-support-matrix).
