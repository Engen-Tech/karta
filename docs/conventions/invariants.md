...
- Carriers: the gate's own doc comments ("THE INVOKING TREE"; "every lookup is rescoped to that worktree"); `scripts/hooks/_worktree.py`; AGENTS.md ("which is not decidable from command text").
