...
Karta 2.36.0 supports native macOS and Linux. Native Windows support is deferred to a later release.
...
|Windows x86_64|Not supported in 2.36.0|Native Windows support is deferred to a later release|
