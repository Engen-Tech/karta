...
The first eight ship in the plugin: install karta and they are active in every project you use it in. The last two live in this repository and protect karta's own development. Three of the plugin rules also ship Codex-side twins — see the runtime parity table in [the Codex how-to](codex.md).
